...
Since the pressure field $p$ was previously calculated, all the necessary information to compute $v_x$ (and similarly $v_y$) is now derived. In the following plots the velocities for $K=10\,m/s$ are shown using a vector plot, contour plot and a 3D surface plot.
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=8cm]{2Dheatk10000}
		\caption{A subfigure}
		\label{fig:sub1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=8cm]{2Dheatk100}
		\caption{A subfigure}
		\label{fig:sub2}
	\end{subfigure}
